...
class Server {
  static createSetver(ip, context) async {
    var server = await HttpServer.bind(ip, 8181);
  ...
  static handlePOST(request) async {
    ...
    switch (path) {
      ...
      case "/change_table":
        ...
        break;
      case "/table_color":
        TablesReq.getTableColors(request);
        break;
      case "/drawer_data":
      ...
      case "/shift_Invoice_app_id":
        ...
        break;
      case "/check_shift":
        ShiftReq.getshiftisOpen(request);
        break;
      case "/shift_id":
        ShiftReq.getshiftid(request);
        break;
      default:
    }
  }
