  ...
  static savesyncORderData(data) async {
    ...
    if (orders.length > 0) {
      for (var i = 0; i < orders.length; i++) {
        ...
        order.tax_amount = orderdata["tax_amount"];
        order.voucher_detail = orderdata["voucher_detail"];
        order.voucher_id = orderdata["voucher_id"];
        order.voucher_amount = orderdata["voucher_amount"];
        order.sub_total = orderdata["sub_total"];
        order.sub_total_after_discount = orderdata["sub_total_after_discount"];
        ...
        if (orderdetail.length > 0) {
          for (var i = 0; i < orderdetail.length; i++) {
            ...
            o_details.product_price = detail["product_price"];
            o_details.product_old_price = detail["product_old_price"];
            o_details.product_discount = detail["product_discount"];
            ...
            o_details.detail_amount = detail["detail_amount"];
            o_details.detail_qty = detail["detail_qty"];
            ...
            if (modifire.length > 0) {
              for (var m = 0; m < modifire.length; m++) {
                ...
                m_data.om_amount = modifiredata["om_amount"];
            ...
            if (attribute.length > 0) {
              for (var a = 0; a < attribute.length; a++) {
                ...
                attr.attr_price = attributeDt["this.attr_price"];
